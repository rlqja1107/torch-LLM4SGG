...
with open("triplet_extraction_process/alignment_dict/aligned_entity_dict_vg.pkl", 'rb') as f:
    aligned_entity_dict = pickle.load(f)
    
with open("triplet_extraction_process/alignment_dict/aligned_predicate_dict_vg.pkl", 'rb') as f:
