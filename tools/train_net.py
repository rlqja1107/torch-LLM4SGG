...
def train(cfg, local_rank, distributed, use_tensorboard=False,):
    ...
    download_GLIP(cfg.MODEL.WEIGHT)
...
def download_GLIP(file_path):
    if not os.path.isfile(file_path):
        #os.system("wget https://penzhanwu2bbs.blob.core.windows.net/data/GLIPv1_Open/models/glip_tiny_model_o365_goldg_cc_sbu.pth -O swin_tiny_patch4_window7_224.pth")
        os.system("wget https://huggingface.co/GLIPModel/GLIP/resolve/main/glip_tiny_model_o365_goldg_cc_sbu.pth")
        os.system("mv glip_tiny_model_o365_goldg_cc_sbu.pth MODEL")
