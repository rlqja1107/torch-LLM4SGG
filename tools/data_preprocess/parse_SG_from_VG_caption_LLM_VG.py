...
vg_dataset = VG150Dataset(split='train',
                         ...
                         num_val_im=5000, filter_empty_rels=True, filter_non_overlap=False,
...
processed_vg_caption_file = 'dataset/VG_Caption/aligned_triplet_info_vg.json'
...
if os.path.exists(processed_vg_caption_file):
    ...
    with open('dataset/VG_Caption/region_descriptions.json', 'r') as fin:
