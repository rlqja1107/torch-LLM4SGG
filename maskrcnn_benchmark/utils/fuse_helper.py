...
class BiAttentionBlockForCheckpoint_Pred(nn.Module):
    def __init__(self, v_dim, l_dim, embed_dim, num_heads, hidden_dim=None, dropout=0.1,
                 drop_path=.0, init_values=1e-4, cfg=None):
        """
        Inputs:
            ...
            dropout - Amount of dropout to apply in the feed-forward network
        """
        super(BiAttentionBlockForCheckpoint_Pred, self).__init__()
    ...
    def forward(self, q, l, attention_mask_l=None, dummy_tensor=None):
