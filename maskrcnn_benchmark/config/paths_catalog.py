...
class DatasetCatalog(object):
    DATASETS = {
        ...
        "cccaption_scene_graph": {
            "img_dir": "dataset/CC/images",
            "caption_scene_graph_file": "dataset/CC/aligned_triplet_cc4vg_grounded.json",
            'img_meta_info_file': 'dataset/CC/cc_meta_information.json'
        },
        ...
        "cococaption_scene_graph": {
            ...
            "caption_scene_graph_file": "dataset/VG/aligned_triplet_coco4vg_grounded.json"
        },
        ...
        "vgcaption_scene_graph": {
            "img_dir": "dataset/VG/images",
            "img_meta_info_file": "dataset/VG/image_data.json",
            "caption_scene_graph_file": "dataset/VG_Caption/aligned_triplet_vgcaption4vg_grounded.json"
        },
        # unbounded SGG
    ...
    def get(name, cfg=None):
        ...
        if name.endswith('_bg'):
            ...
            elif 'cococaption_scene_graph' in name or 'cococaption_scene_graph4GQA' in name:
                args = copy.deepcopy(DatasetCatalog.DATASETS[name])
                data_dir = try_to_find(args["img_dir"], return_dir=True)
                for k, v in args.items():
                    args[k] = os.path.join(data_dir, v)
