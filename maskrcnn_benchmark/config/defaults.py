...
_C = CN()
_C.DATA_DIR = "/home/public/Datasets/CV/open-imagev6"
...
_C.DATASETS.TRAIN = ()
_C.DATASETS.CHOICE = 'VG'
_C.DATASETS.ZEROSHOT_PATH = 'maskrcnn_benchmark/data/datasets/evaluation/vg150/zeroshot_triplet.pytorch'
...
_C.MODEL.ROI_RELATION_HEAD.LONGTAIL_PART_DICT = [None, 'h', 'h', 'h', 't', 'b', 't', 't', 'h', 'h', 'b', 't', 't', 't', 'b', 't', 't',
